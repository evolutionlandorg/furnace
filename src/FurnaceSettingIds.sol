...
contract FurnaceSettingIds {
    ...
    bytes32 internal constant CONTRACT_LP_RING_ERC20_TOKEN = "CONTRACT_RING_ERC20_TOKEN";

    bytes32 internal constant CONTRACT_LP_KTON_ERC20_TOKEN = "CONTRACT_KTON_ERC20_TOKEN";
}
