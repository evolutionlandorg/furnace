...
# This script installs Nix, Cachix, and fnc-cli
...
{ # Prevent execution if this script was only partially downloaded
  ...
  { have nix; } || {
    echo "fnc-cli uses the Nix package manager to install programs behind the scenes."
  ...
  nix-env -i -f /Users/echo/workspace/contract/evolutionlandorg/furnace/fnc 
  # Finished!
  cat <<EOF

Installation finished!

You now have access to fnc-cli.

Please logout and log back in to start using fnc-cli, or run
